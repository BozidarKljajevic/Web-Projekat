<template>
  <nav class="navbar navbar-expand-lg sticky-top navbar-light mb-4" style="background-color: #4da6ff; margin: 1% 1% 1% 1%; border-radius: 25px">
    <div class="container">
      ...
      <ul class="navbar-nav mr-0">
        ...
        <template v-else>
          ...
          <router-link to="/login" tag="li" class="nav-item">
            <button class="btn btn-outline-primary my-0">Uloguj se</button>
          </router-link>
        </template>
